...
A browser studio for **9:16 history reels** in this card format:

```
30. The End of Apartheid (1994)
...
Dark nebula background, lime accents, episode number + title + year, a photo with caption and credit, full-sentence bullets, then hashtags. Watermark defaults to `@FactsOrWhacks`.
...
2. Set the episode number, title, and year.
