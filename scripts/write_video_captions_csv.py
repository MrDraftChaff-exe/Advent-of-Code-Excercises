...
def extra_rows() -> list[dict[str, str]]:
    ...
    return [
        ...
        extra_row(
            n=407,
            title="Squeaky Fromme",
            year="1975",
            filename="407-squeaky-fromme.mp4",
            caption_path=catalog / "squeaky-fromme-post.txt",
            credit="Photo: Ricardo Thomas / White House, 1975 · Public domain",
        ),
        extra_row(
            n=408,
            title="Magellan",
            year="1522",
            filename="408-magellan.mp4",
            caption_path=catalog / "magellan-post.txt",
            credit="Photo: Christian Ferrer, 2016 · CC BY 4.0",
        ),
        extra_row(
            n=409,
            title="Star Trek",
            year="1966",
            filename="409-star-trek.mp4",
        ...
        extra_row(
            ...
            title="Fort McHenry",
            year="1814",
            filename="413-fort-mchenry.mp4",
            caption_path=catalog / "star-spangled-banner-post.txt",
        ...
        extra_row(
            ...
            title="Pirates",
            year="1718",
            filename="416-pirates.mp4",
            caption_path=catalog / "pirate-day-post.txt",
