...
function buildDescriptionHtml(meta, dir) {
  ...
  body += `<p>From <strong>Buckeye Trail Guide</strong> — printable guides curated by Clayton Householder, a Columbus Ohio native. Topics span personal life, local know-how, settling in, planning, and everyday admin — whatever helps you get the next thing done with less friction.</p>`;
